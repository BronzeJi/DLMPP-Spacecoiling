function [absoropeZ,Z]=Absorption_DLMMP(f,envir_cons,Plate1,Plate2)
    w=2*pi*f;%omega
    c=envir_cons.c;
    u=envir_cons.mu;
...
%     absoropeZ3=Alpha(Z3);% mass and air gap
    ...
    figure;
    plot(f,absoropeZ1,"-.","LineWidth",5);hold on;
    plot(f,absoropeZ2ndlayer,"--","LineWidth",5); hold on;
    plot(f,absoropeZ,"LineWidth",5);hold off;
